...
if __name__ == "__main__":
    ...
    parser.add_argument("--txt", type=str, default="./text.txt", help="Path to text file")
    parser.add_argument(
        "--output_dir", type=str, default="./outputs", help="Path to output directory"
    )
    parser.add_argument(
        "--res_zip", type=str,
        default=r"/home/zhaoming/.cache/modelscope/hub/damo/speech_sambert-hifigan_tts_zh-cn_16k/resource",
        help="Path to resource zip file"
    )
    parser.add_argument(
        "--am_ckpt", type=str,
        default=r"/home/zhaoming/.cache/modelscope/hub/damo/speech_sambert-hifigan_tts_zh-cn_16k/voices/zhibei_emo/am",
        help="Path to am ckpt file"
    )
    parser.add_argument(
        "--voc_ckpt", type=str,
        default=r"/home/zhaoming/.cache/modelscope/hub/damo/speech_sambert-hifigan_tts_zh-cn_16k/voices/zhibei_emo/vocoder",
        help="Path to voc ckpt file"
    )
    parser.add_argument(
        "--speaker",
        type=str,
